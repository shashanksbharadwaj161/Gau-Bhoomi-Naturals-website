                  ...
                  {results.map((product) => {
                    ...
                    return (
                      <li key={product.id}>
                        ...
                        >
                          <div className="relative w-12 h-12 rounded-lg overflow-hidden bg-primary-500 flex-shrink-0">
                            <div className="absolute inset-0 flex items-center justify-center">
                              <span className="text-gold-400 text-[10px] font-display">GBN</span>
                            </div>
                            {image && <img src={image} alt={product.name} loading="lazy" onError={(e) => { e.currentTarget.style.display = 'none' }} className="absolute inset-0 w-full h-full object-cover" />}
                          </div>
